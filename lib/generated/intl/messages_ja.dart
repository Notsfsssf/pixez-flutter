...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "clear_completed_tasks" : MessageLookupByLibrary.simpleMessage("完了した処理を削除する"),
    ...
    "copymessage" : MessageLookupByLibrary.simpleMessage("イラスト情報をクリップボードにコピーする"),
    ...
    "old_way_message" : MessageLookupByLibrary.simpleMessage("To save the picture in the traditional way,app need to obtain the read and write permission of the external storage space, and select a folder to continue"),
